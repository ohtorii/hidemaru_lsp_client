...
/* Standard interface: ILspClientLogger, ver. 0.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO ILspClientLogger_ProxyInfo;


static const RPC_CLIENT_INTERFACE ILspClientLogger___RpcClientInterface =
    {
    ...
    0,
    0,
    &ILspClientLogger_ProxyInfo,
    0x02000000
    };
RPC_IF_HANDLE ILspClientLogger_v0_0_c_ifspec = (RPC_IF_HANDLE)& ILspClientLogger___RpcClientInterface;

extern const MIDL_STUB_DESC ILspClientLogger_StubDesc;

static RPC_BINDING_HANDLE ILspClientLogger__MIDL_AutoBindHandle;


/* [propget] */ HRESULT get_IsFatalEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{

    CLIENT_CALL_RETURN _RetVal;

    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&ILspClientLogger_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  ret);
...
/* [propget] */ HRESULT get_IsErrorEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{
...
/* [propget] */ HRESULT get_IsWarnEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{
...
/* [propget] */ HRESULT get_IsInfoEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{
...
/* [propget] */ HRESULT get_IsDebugEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{
...
/* [propget] */ HRESULT get_IsTraceEnabled( 
    /* [in] */ handle_t IDL_handle,
    /* [retval][out] */ boolean *ret)
{
...
static const MIDL_STUB_DESC ILspClientLogger_StubDesc = 
    {
    (void *)& ILspClientLogger___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &ILspClientLogger__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& ILspClientLogger_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO ILspClientLogger_ProxyInfo =
    {
